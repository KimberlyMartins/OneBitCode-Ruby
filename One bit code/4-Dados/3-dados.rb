...
=begin
Primeiro pesquisei todas as séries
...
Aqui mostra todas as séries depois da exclusão, com uma linha excluída.

DELETE FROM tv_series WHERE title='The Office';
DELETE 1

Query returned successfully in 181 msec.

streaming=#  SELECT * FROM tv_series;
 id |      title       |                   creator                   | release_year |      genre       | seasons | episodes | rating |     network     | status
----+------------------+---------------------------------------------+--------------+------------------+---------+----------+--------+-----------------+--------
  1 | Breaking Bad     | Vince Gilligan                              |         2008 | Drama            |       5 |       62 |   9.50 | AMC             | Ended
  2 | Game of Thrones  | David Benioff, D.B. Weiss                   |         2011 | Fantasy          |       8 |       73 |   9.30 | HBO             | Ended
...
=end 
 ...
 Também podemos fazer a exclusão usando mais de uma condição.
 DELETE FROM tv_series WHERE release_year < 2000 AND seasons > 5;
