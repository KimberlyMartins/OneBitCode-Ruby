...
- RESTRICT / NO ACTION → bloqueia exclusão/atualização se houver filhos.
               ...
               EXEMPLOS INTEGRIDADE REFERENCIAL
...
DELETE FROM customers WHERE id = 1; # Ao tentar apagar, lançará um erro de violação de constraint
Como não definimos uma cláusula, pelo padrão sql ele vai bloquear a exclusão para manter a integridade referencial!
...
Agora sim podemos experimentar excluir e atualizar o ID de alguns registros para ver o resultados 
